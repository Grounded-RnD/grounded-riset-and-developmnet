...
export default function Interest() {
  return (
    <React.Fragment>
      <section id="join-team" className="flex mt-10 font-glancyr items-center justify-center h-screen bg-cover bg-center max-h-[530px]" style={{ backgroundImage: `url('/images/interest-background.svg')`, opacity: 0.8 }}>
        <div className="text-center py-6 px-12 lg:px-96 bg-opacity-80 rounded">
          ...
          <br />
          <p className="text-base md:text-2xl font-light text-black mb-8">We are ready to help you achieve your technology goals. Contact us for more information about our products and services.</p>
          <Link
            href={"/contact"}
