...
export default function Project() {
  return (
    <React.Fragment>
      <section id="projects" className="h-full w-full bg-dark-100 pt-32">
        <main className="max-w-full px-4 lg:px-10 xl:flex justify-center lg:gap-x-20">
          <div className="max-w-sm">
            <h2 data-aos="fade-right" data-aos-duration="1000" className="font-glancyr text-surface-50 xl:text-[48px] lg:text-[44px] md:text-[40px] sm:text-[38px] text-[36px]">
            ...
            <p
              ...
              className="font-light xl:text-[16px] lg:text-[15px] md:text-[14px] sm:text-[13px] text-[12px] text-surface-50 mt-5 mb-8 xl:max-w-full max-w-sm pr-20 lg:pr-0"
            >
            ...
            <div data-aos="fade-up" data-aos-delay="1000" data-aos-duration="1000">
              <LinkButton href="#" variant="primary" className="w-fit px-10">
                Show All
              </LinkButton>
            </div>
          </div>
          <div className="max-w-4xl w-fit grid grid-cols-1 lg:grid-cols-2 lg:grid-rows-4 gap-4 mt-10 xl:mt-0">
