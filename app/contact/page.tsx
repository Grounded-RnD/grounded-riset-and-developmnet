...
export default function contact() {
  return (
    <main>
      <div className="bg-dark-300 text-surface-50 p-8 sm:p-16 lg:p-24 rounded-lg mx-4 sm:mx-16 lg:mx-32 mt-32 sm:mt-32 lg:mt-32">
        <h2 className="text-xl sm:text-2xl font-medium mb-4">Our Contact</h2>
        <p className="text-base sm:text-lg font-thin mb-6">
          We are ready to help you achieve your technology goals. Contact us for
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-16 lg:gap-32">
          <div>
            <h3 className="text-lg sm:text-xl font-semibold mb-2">
              For Innovative Products and Startups
            </h3>
            <br /><br />
            ...
            <p className="font-light">
              <strong>Address:</strong> SMK Telkom Malang, Laboratorium 6 /
              Grounded Workspace, Jl. Danau Ranau, Sawojajar, Kec. Kedungkandang,
