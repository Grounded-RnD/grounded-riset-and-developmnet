...
export default function CustomCursor({ isHovering }: Readonly<CustomCursorProps>) {
  ...
  return (
    <div
      className={`pointer-events-none fixed left-0 top-0 z-[9999] hidden border  drop-shadow-glow md:inline-block ${
        isHovering ? "h-7 w-7 bg-transparent border-surface-50" : "h-3 w-3 bg-surface-50 border-surface-900"
